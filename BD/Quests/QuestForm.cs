...
namespace BD
{
    public partial class QuestForm : Form
    {
        ...
        public QuestForm(MainForm.RequestrDelegate quest1)
        {
            ...
            MainForm.DataBase.SetComboBox(Q3ClassComboBox, "CLASS", "NAME");
            MainForm.DataBase.SetComboBox(Q4TeacherComboBox, "TEACHER", "LAST_NAME");
            MainForm.DataBase.SetComboBox(SQ1ClassComboBox, "CLASS", "NAME");
            Q4SetThing();
            MainForm.DataBase.SetComboBox(dayOfWeek, Q1WeekComboBox);
            MainForm.DataBase.SetComboBox(dayOfWeek, Q3WeekComboBox);
            MainForm.DataBase.SetComboBox(dayOfWeek, Q5WeekComboBox);
            MainForm.DataBase.SetComboBox(Q5ClassComboBox, "CLASS", "NAME");
